...
export default class HGSyatir extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            return (
                <View style={styles.contContainer} >
                    <TouchableOpacity style={styles.buttonContainer}
                       onPress={()=> this.props.navigation.navigate('HesapSecHgs', { token: this.state.token ,hgsNo:hesap.hgsNo}) } >
                        <Text style={styles.hesapNo}> {hesap.hgsNo}  </Text>
